...
(function() {
  $(function() {
    return $("#flow-text-btn").click(function() {
      return $("#flow-text").toggleClass('flow-text');
    });
  });

  $(function() {
    $("#style-default").click(function() {
      return $("body").attr("id", "default");
    });
    $("#style-ai").click(function() {
      return $("body").attr("id", "ai");
    });
    $("#style-bloomberg").click(function() {
      return $("body").attr("id", "bloomberg");
    });
    return $("#style-silver").click(function() {
      return $("body").attr("id", "silver");
    });
  });
